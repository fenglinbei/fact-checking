...
# FullFT on baseline20 atom-anchor evidence, training recipe aligned to the
...
export MREC_POLICY_CONFIG="${MREC_POLICY_CONFIG:-configs/experiment/mrec_v0.2/rawfc_llama31_learned_marginal_proxy_fullpool_minmax5_10_baseline20_fullft_migrecipe.yaml}"
