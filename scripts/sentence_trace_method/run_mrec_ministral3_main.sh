...
MREC_MIN_STEPS="${MREC_MIN_STEPS:-0}"
...
MREC_POST_TARGET_FILL_POLICY="${MREC_POST_TARGET_FILL_POLICY:-contrast_only}"
...
prepare_mrec_sources_for() {
  ...
  PYTHON_BIN="$PYTHON_BIN" \
    ...
    POST_TARGET_FILL_POLICY="$MREC_POST_TARGET_FILL_POLICY" \
