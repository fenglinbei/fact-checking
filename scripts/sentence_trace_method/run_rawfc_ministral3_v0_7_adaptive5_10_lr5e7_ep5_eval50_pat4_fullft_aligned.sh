...
export CASE_SUFFIX="${CASE_SUFFIX:-__v0_7_bm_adaptive5_10_fullft_ebs16_lr5em7_ep5_eval50_pat4_rawfc}"
export SFT_LEARNING_RATE="${SFT_LEARNING_RATE:-5e-7}"
export SFT_NUM_TRAIN_EPOCHS="${SFT_NUM_TRAIN_EPOCHS:-5}"
export SFT_EVAL_STEPS="${SFT_EVAL_STEPS:-50}"
export SFT_SAVE_STEPS="${SFT_SAVE_STEPS:-$SFT_EVAL_STEPS}"
export SFT_EARLY_STOPPING_PATIENCE="${SFT_EARLY_STOPPING_PATIENCE:-4}"
