...
RUN_NAME="${RUN_NAME:-liar_raw__ministral3_8b__v0_7_bm_adaptive5_10__qec_min_lora_ebs16_lr2em5_ep12_eval100_pat8_liarw}"
SPLIT="${SPLIT:-test}"
...
printf '\n[liar-raw-ministral3-qec-min-test-eval] RUN_NAME=%s SPLIT=%s CHECKPOINT=%s OUTPUT_DIR=%s LOGIT_ADJUST=off\n' \
