...
printf '[liar-raw-ministral3-selector-mechanism-s0-s4-plain] DATASETS=%s MODELS=%s MODE=%s EVAL_SPLITS=%s RUN_TAU_EVAL=%s TRACE_PROMPT_STYLE=%s FORCE_STAGE=%s SELECTORS=%s LORA_SUFFIX=%s EXPECTED_CHUNK_MMR_FINGERPRINT=%s\n' \
