...
#
# Usage:
#   bash scripts/phase1_pipeline/run_b3_mmr_topk_sweep_1024.sh
#   TOP_KS="14,16,18" bash scripts/phase1_pipeline/run_b3_mmr_topk_sweep_1024.sh
#   PIPELINE_MODE=build bash scripts/phase1_pipeline/run_b3_mmr_topk_sweep_1024.sh
...
TOP_KS="${TOP_KS:-0,1,2,3,4,5,6,7,8}"
