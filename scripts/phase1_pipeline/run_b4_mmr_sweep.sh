...
#
# 用法:
#   bash scripts/phase1_pipeline/run_b4_mmr_sweep.sh
#   MMR_LAMBDAS="0.0,0.5,1.0" bash scripts/phase1_pipeline/run_b4_mmr_sweep.sh
#   PIPELINE_MODE=build bash scripts/phase1_pipeline/run_b4_mmr_sweep.sh   # 仅 build 阶段
#
