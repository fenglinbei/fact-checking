...
#
# 用法:
#   bash scripts/phase1_pipeline/run_mmr_lambda_sweep.sh
#   MMR_LAMBDAS="0.0,0.5,1.0" bash scripts/phase1_pipeline/run_mmr_lambda_sweep.sh
#   PIPELINE_MODE=build bash scripts/phase1_pipeline/run_mmr_lambda_sweep.sh   # 仅 build 阶段
#
