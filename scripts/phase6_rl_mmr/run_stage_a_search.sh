...
# 再调用 scripts/phase6_rl_mmr/search_sensitivity_thresholds.py 扫
# (θ_s, θ_r, λ_low, gating_mode, ε) 网格。
#
# 用法:
#   bash scripts/phase6_rl_mmr/run_stage_a_search.sh \
...
python scripts/phase6_rl_mmr/search_sensitivity_thresholds.py --config "${SEARCH_CFG}"
