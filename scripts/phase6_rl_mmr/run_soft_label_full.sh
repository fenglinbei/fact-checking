...
#
# Usage:
#   bash scripts/phase6_rl_mmr/run_soft_label_full.sh [INFERENCE_MODE] [EXPERIMENT] [MODE]
#
# Examples:
#   bash scripts/phase6_rl_mmr/run_soft_label_full.sh argmax
#   MODEL_PATH=outputs/rl_mmr/soft_label/mlp bash scripts/phase6_rl_mmr/run_soft_label_full.sh expected
# ==============================================================================
set -euo pipefail
