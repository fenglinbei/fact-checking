"""Selection-only eval for the Step4 sequential pointer evidence selector."""
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Evaluate sequential selector against Stage2 oracle order.")
...
def main() -> None:
    ...
    for batch in tqdm(
        ...
        desc=f"sequential selector eval [{args.split}]",
        unit="batch",
        dynamic_ncols=True,
    ...
    metrics = {
        ...
        "controls": controls,
        "step_diagnostics": summarize_sequential_step_diagnostics(traces),
    ...
    print(
        "Sequential Recall@5={rec:.4f}, Jaccard@5={jac:.4f}, "
