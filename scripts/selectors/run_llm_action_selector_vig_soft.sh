...
MODEL_NAME="${MODEL_NAME:-/home/fenglin/project/hateSpeechDetection/models/base/Qwen2.5-7B-Instruct}"
OUTPUT_DIR="${OUTPUT_DIR:-outputs/selectors/llm_action_selector/qwen25_7b_vig_soft}"
