...
Usage:
    PYTHONPATH=src python scripts/phase2_learned_lambda/evaluate_predictor.py \
...
def main() -> None:
    ...
    if not chunk_mmr_cache.exists():
        raise FileNotFoundError(
            ...
            "Run scripts/phase2_learned_lambda/run_generate_oracle_prompts.sh first, "
    ...
    chunk_samples = load_pickle(chunk_mmr_cache)
