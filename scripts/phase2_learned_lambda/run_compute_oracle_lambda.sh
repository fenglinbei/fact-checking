...
#
# Usage:
#   bash scripts/phase2_learned_lambda/run_compute_oracle_lambda.sh
#   SPLIT_NAME=val bash scripts/phase2_learned_lambda/run_compute_oracle_lambda.sh
#   MODEL=/data/models/Qwen2.5-7B-Instruct TENSOR_PARALLEL_SIZE=4 bash scripts/phase2_learned_lambda/run_compute_oracle_lambda.sh
#   MODEL=/data/models/Qwen2.5-7B-Instruct LORA_ADAPTER=outputs/runs/.../train/best bash scripts/phase2_learned_lambda/run_compute_oracle_lambda.sh
#   PROMPTS_DIR=outputs/learned_lambda/prompts OUTPUT=outputs/learned_lambda/oracle_lambda_train.jsonl bash scripts/phase2_learned_lambda/run_compute_oracle_lambda.sh
#   PROGRESS=false bash scripts/phase2_learned_lambda/run_compute_oracle_lambda.sh
#
# Extra CLI args are forwarded to compute_oracle_lambda.py, for example:
#   bash scripts/phase2_learned_lambda/run_compute_oracle_lambda.sh --default-lambda 0.5
...
if [[ ! -d "${PROMPTS_DIR}" ]]; then
  ...
  echo "[run_compute_oracle_lambda] Run scripts/phase2_learned_lambda/run_generate_oracle_prompts.sh first, or set PROMPTS_DIR." >&2
  exit 1
fi
...
cmd=(
  python scripts/phase2_learned_lambda/compute_oracle_lambda.py
