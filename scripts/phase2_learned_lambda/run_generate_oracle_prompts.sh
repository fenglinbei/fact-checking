...
#
# Usage:
#   bash scripts/phase2_learned_lambda/run_generate_oracle_prompts.sh
#   SPLIT_NAME=val bash scripts/phase2_learned_lambda/run_generate_oracle_prompts.sh
#   REBUILD_PREMMR_CACHE=false bash scripts/phase2_learned_lambda/run_generate_oracle_prompts.sh
#   LAMBDA_GRID="0.00,0.25,0.50,0.75,1.00" bash scripts/phase2_learned_lambda/run_generate_oracle_prompts.sh
#   CONFIG_OVERRIDES="build.retrieval.chunking.theta=0.6" bash scripts/phase2_learned_lambda/run_generate_oracle_prompts.sh
#   TOP_K=16 bash scripts/phase2_learned_lambda/run_generate_oracle_prompts.sh
#   PREMMR_CACHE=outputs/cache/pre_mmr/<fingerprint>/train.pkl REBUILD_PREMMR_CACHE=false bash scripts/phase2_learned_lambda/run_generate_oracle_prompts.sh
#   CHUNK_MMR_CACHE=outputs/cache/chunk_mmr/<fingerprint>/train.pkl REBUILD_CHUNK_MMR_CACHE=false bash scripts/phase2_learned_lambda/run_generate_oracle_prompts.sh
#   PROGRESS=false bash scripts/phase2_learned_lambda/run_generate_oracle_prompts.sh
#
# Extra CLI args are forwarded to generate_oracle_prompts.py, for example:
#   bash scripts/phase2_learned_lambda/run_generate_oracle_prompts.sh --top-k 14
...
cmd=(
  python scripts/phase2_learned_lambda/generate_oracle_prompts.py
