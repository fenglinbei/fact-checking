...
#
# 用法:
#   bash scripts/pipeline/run_b4_3class.sh
#   PIPELINE_MODE=build bash scripts/pipeline/run_b4_3class.sh   # 仅 build 阶段
#   PIPELINE_MODE=train bash scripts/pipeline/run_b4_3class.sh   # 仅训练
#
