...
SELECTORS="${SELECTORS:-map_selector_s0_retrieval_top5 map_selector_s1_mmr_pool_top5 map_selector_s2_map_quality_top5}"
...
for split in ${SPLITS}; do
  ...
  for selector in ${SELECTORS}; do
    ...
    echo "[liar-raw-map-selector-ablation] split=${split} selector=${selector}"
    echo "[liar-raw-map-selector-ablation] input=${input}"
    echo "[liar-raw-map-selector-ablation] output=${output_dir}"
