...
export FULLFT_EXPERIMENT="${FULLFT_EXPERIMENT:-v0_6c_rawfc3_rule_step_adaptive3_8_eval25_fullft_base1024_true3}"
export FULLFT_CONFIG="${FULLFT_CONFIG:-configs/experiment/v0_6c_rawfc3_rule_step_adaptive3_8_eval25_fullft_base1024_true3.yaml}"
export FULLFT_CASE_TUNING_SUFFIX="${FULLFT_CASE_TUNING_SUFFIX:-_base1024_true3}"
