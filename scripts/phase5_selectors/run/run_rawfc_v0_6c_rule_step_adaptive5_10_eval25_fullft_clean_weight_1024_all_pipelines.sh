...
export FULLFT_EXPERIMENT="${FULLFT_EXPERIMENT:-v0_6c_rawfc3_rule_step_adaptive5_10_eval25_fullft_clean_weight_1024}"
export FULLFT_CONFIG="${FULLFT_CONFIG:-configs/experiment/v0_6c_rawfc3_rule_step_adaptive5_10_eval25_fullft_clean_weight_1024.yaml}"
