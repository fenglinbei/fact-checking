...
def main() -> None:
    ...
    for atom_row in atom_pool_rows:
        ...
        union_row = build_atom_union_pool_row(baseline_row=baseline_row, atom_pool_row=atom_row)
    ...
    metrics_path = out_dir / "atom_union_metrics.json"
    manifest_path = out_dir / "atom_union_manifest.json"
    ...
    write_json(out_dir / f"atom_union_manifest_{args.split}.json", _json_safe(manifest))
