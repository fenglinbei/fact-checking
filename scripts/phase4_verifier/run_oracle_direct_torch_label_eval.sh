...
#
# Examples:
#   CHECKPOINTS=best bash scripts/phase4_verifier/run_oracle_direct_torch_label_eval.sh
#   CHECKPOINTS=best,checkpoint-600 PER_DEVICE_EVAL_BATCH_SIZE=2 bash scripts/phase4_verifier/run_oracle_direct_torch_label_eval.sh
...
#     bash scripts/phase4_verifier/run_oracle_direct_torch_label_eval.sh
