...
#
# Examples:
#   DRY_RUN=true bash scripts/phase4_verifier/run_oracle_direct_val_evidence_checks.sh
#   CHECKPOINTS=best bash scripts/phase4_verifier/run_oracle_direct_val_evidence_checks.sh
#   RUN_POINTWISE=false CHECKPOINTS=checkpoint-600 bash scripts/phase4_verifier/run_oracle_direct_val_evidence_checks.sh
